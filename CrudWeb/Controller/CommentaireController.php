...
include 'C:\xampp\htdocs\arslenemna\crudweb\Model\Commentaire.php';
...
// Create
    ...
    // Update
    public function updateCommentaire($id_commentaire,$id_film, $auteur, $contenu, $note, $date_commentaire) {
        $stmt = $this->pdo->prepare("UPDATE commentaire SET id_film = ?, auteur = ?, contenu = ?, note = ?, date_commentaire = ? WHERE id_commentaire = ?");
        return $stmt->execute([$id_film ,$auteur, $contenu, $note, $date_commentaire, $id_commentaire]);
    }
