...
include 'C:\xampp\htdocs\arslenemna\crudweb\Controller\CommentaireController.php'; // Add this line
include 'C:\xampp\htdocs\arslenemna\crudweb\Controller\HistoriqueController.php';
  ...
  <div class="wrapper">
    ...
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a data-attr="reclamation" href="http://localhost/arslenemna/View/backoffice/index.php"><i class="fas fa-bell"></i> Réclamation</a>
      </nav>
