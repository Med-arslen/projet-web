...
<body>
  ...
  <li><a href="#"><?= ReclamationController::traduction_form('Catalogue', $lang) ?></a></li>
  <li><a href="event.html"><?= ReclamationController::traduction_form('Événements', $lang) ?></a></li>
  <li><a href="#"><?= ReclamationController::traduction_form('Achat', $lang) ?></a></li>
