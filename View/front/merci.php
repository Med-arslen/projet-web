    ...
    <header class="main-header">
        <nav class="menu-bar">
            ...
            <ul>
                ...
                <li><a href="#"><?= feedbackController::traduction_form('Catalogue', $lang) ?></a></li>
                <li><a href="event.html"><?= feedbackController::traduction_form('Événements', $lang) ?></a></li>
                <li><a href="#"><?= feedbackController::traduction_form('Achat', $lang) ?></a></li>
