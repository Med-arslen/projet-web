document.addEventListener("DOMContentLoaded", () => { 
    ...
    const sliders = document.querySelectorAll('.produit-row');

    sliders.forEach(slider => {
        const slideContainer = slider.querySelector('.produit-slider');
    ...
    // Enhanced Produit hover effects
    ...
    produits.forEach(produit => {
        ...
        produit.addEventListener('mouseenter', () => {
            ...
            produit.style.transform = 'scale(1.3)';
            produit.style.zIndex = '10';

            // Show produit info with delay
            const produitInfo = produit.querySelector('.produit-info');
            if (produitInfo) {
                produitInfo.style.bottom = '0';
            }
        });
        ...
        produit.addEventListener('mouseleave', () => {
            timeoutId = setTimeout(() => {
                ...
                produit.style.zIndex = '1';

                // Hide produit info
                const produitInfo = produit.querySelector('.produit-info');
                if (produitInfo) {
                    produitInfo.style.bottom = '-100%';
                }
            }, 200);
        });
    });
    ...
    // Add event listener to the 'Confirmer la commande' button
