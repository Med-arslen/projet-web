...
<head>
  ...
  <link rel="stylesheet" href="assets/css/styyyle.css">
  ...
  <div class="wrapper">
    ...
    <header>
      <div class="netflixLogo">
        <a id="logo" href="#home"><img src="assets/images/logo.png" alt="Logo Image" id="logo1"></a>
      </div>      
      <nav class="main-nav">                
        <a href="#home">Accueil</a>
        <a href="#tvShows">Catalogue</a>
        <a href="#movies">Evenement</a>
        <a href="#originals">Achat</a>
        <a href="#">Recently Reclamation</a>
                
      </nav>
      <nav class="sub-nav">
        <a href="#"><i class="fas fa-search"></i></a>
        <a href="#"><i class="fas fa-bell"></i></a>
        <a href="views/login.php"><i class="fas fa-user"></i></a>        
      </nav>      
    </header>
    <!-- END OF HEADER -->
    ...
    <div class="user-banner">
      <h2 id="welcomeUser">Bienvenue !</h2>
